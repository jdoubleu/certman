...
/**
 * ISO 3166 Alpha 2 country codes taken from
 * https://raw.githubusercontent.com/lukes/ISO-3166-Countries-with-Regional-Codes/master/all/all.json
 * processed with node:
 * require('./iso3166-alpha2-codes.json').map(m => m['alpha-2']).map(v => "\"" + v + "\"").toString()
 */
string core::Environment::iso3166_alpha2_codes[] = {
